...
function outputEvents(e) {
    output.addEventListener('click', function(e) {
        ...
        let HideOptions = e.target.id === "options";


        if (iconPressed) {
            let iconStyle = e.target.style.visibility = 'hidden';
            HideOptions = iconStyle;
            console.log(iconPressed = iconStyle);
            e.target.id == "edit" (hide);
        }
