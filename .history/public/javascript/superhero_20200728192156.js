...
function loadcomments() {
    ...
    .then(response => {
        ...
        .then(function(data) {
            io.emit("new_message", outcom = comments.value);
            io.on("new_message", function(outcom) {
                console.log("Server says", outcom);
                ...
                data.forEach(function(user) {
                    ...
                    var display_comments = document.createTextNode(outcom);
