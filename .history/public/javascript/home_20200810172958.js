                ...
                data.forEach(function(user) {
                 ...
                 <div class="output">
                    ...
                    <h6 class="date"> ${user.date}
                        ...
                        <div class="options">
                        <button id="edit"><i class="fas fa-pencil-alt editIcon"></i> </button> 
                        <button id="delete"><i class="fas fa-trash deleteIcon"></i> </button> 
                        </div>
                    </h6>
...
function outputEvents() {
    output.addEventListener('click', function(e) {
        let icon = e.target.class == 'icon';
        let deletebtnPressed = e.target.parentElement.class == 'delete';
        let editbtnPressed = e.target.class == 'edit';
