    ...
    fetch('http://localhost:5502' + '/get_messages')
        ...
        .then(function(data) {
            ...
            data.forEach(function(user) {
                ...
                newUser.appendChild(display_username = document.createTextNode(user.username).appendChild(newName));
                newUser.appendChild(display_date = document.createTextNode(user.date));
                newUser.appendChild(display_comments = document.createTextNode(user.comments));

                // newUser.appendChild(display_username);
                // newUser.appendChild(display_date);
                // newUser.appendChild(display_comments);
