    ...
    fetch('http://localhost:5502' + '/get_messages')
        ...
        .then(function(data) {
            ...
            data.forEach(function(user) {
                ...
                var display_username = document.textContent(JSON.stringify(user.username));
                var display_date = document.textContent(JSON.stringify(user.date));
                var display_comments = document.textContent(JSON.stringify(user.comments));
