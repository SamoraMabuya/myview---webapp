...
function outputEvents(e) {
    ...
    output.addEventListener('click', function(e) {
        ...
        var Select = e.target.className = 'options';



        if (iconPressed) {
            Select.forEach(function(theIcon) {
                theIcon.classList.add('is-hidden');
                let nedscw = e.target.id = 'options' == classList.add('is-hidden');
                nedscw;
            })
        }
    })
