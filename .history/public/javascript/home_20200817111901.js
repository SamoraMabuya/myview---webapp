            ...
            io.on("new_message", function(data) {
                ...
                data.forEach(function(user) {
                    ...
                    newIcon.addEventListener('mouseover', function() {
                        // NewIconOptions.classList.toggle('is-hidden');
                        newIcon.onmouseover = NewIconOptions.classList.add('is-hidden');
                        newIcon.onmouseout = NewIconOptions.classList.remove('is-hidden');
