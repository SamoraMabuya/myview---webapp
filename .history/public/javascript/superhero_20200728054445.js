...
comments.addEventListener('keypress', function() {
    io.emit('typing', comments.value);
})

io.on('typing', function(message) {
    var omitMessage = document.createElement("h6");
    omitMessage.textContent = message;
})
