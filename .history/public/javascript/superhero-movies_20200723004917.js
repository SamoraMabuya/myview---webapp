...
submitbtn.addEventListener("click", function() {
    ...
    results.forEach((output) =>

        {
            ...
            newName = document.createTextNode(output.username);
            newDate = document.createTextNode(output.date);
            newMessage = document.createTextNode(output.comments);

            output.appendChild(newName);
            output.appendChild(newDate);
            output.appendChild(newMessage);

            document.getElementById('output').appendChild(newUser);
