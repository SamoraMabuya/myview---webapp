    ...
    .then(response => {
        ...
        .then(function(data) {
                ...
                data.forEach(function(user) {
                        ...
                        var display_username = document.createTextNode({
                                user.username);
                            ...
                            newUser.appendChild(newName); newUser.appendChild(newDate); newUser.appendChild(newMessage); output.appendChild(newUser);
