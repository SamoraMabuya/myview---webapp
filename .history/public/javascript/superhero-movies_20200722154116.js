...
var form = document.getElementById('mario-chat');
...
function userData() {
    socket.emit("chat", input_comments)

    return false;
}

socket.on("chat", function(data) {
    output.innerHTML += "<li>" + input_comments + "<li>"
        // console.log(data);
        // document.getElementById("users").innerHTML += output.innerHTML;
})
