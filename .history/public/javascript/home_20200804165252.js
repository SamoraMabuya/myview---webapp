        ...
        .then(function(data) {
            ...
            io.on("new_message", function(data) {
                ...
                data.forEach(function(user) {
                    ...
                    output.appendChild('<i class="fas fa-ellipsis-v"></i>');
                    newUser.appendChild('<i class="fas fa-ellipsis-v"></i>')
