...
function outputEvents(e) {
    ...
    output.addEventListener('click', function(e) {
        let iconPressed = e.target.classList == "icon";


        if (iconPressed) {
            let optionsd = e.target.classList == "edit";

            // let options = e.target.classList.add('is-hidden');
            let hide = e.target.style.visibility = 'hidden';
            optionsd.classList = hide;
            // Options.e.target.classList = ('is-hidden');
        }
