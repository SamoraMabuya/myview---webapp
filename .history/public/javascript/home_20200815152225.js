                ...
                data.forEach(function(user) {
                 ...
                 <div class="output" data-id=${user.id}>
                    ...
                    <h6 class="date"> ${user.date}
                        <i class="fas fa-ellipsis-v icon" id="icon" data-id=${user.id}></i>
...
function outputEvents(e) {
    output.addEventListener('click', function(e) {
        ...
        const deletebtn = e.target.id === "delete";
        HideShow(id);
    ...
    function HideShow(id) const options = e.target.className === "options";

    if (e.target.id === "icon") {
        e.target.className === "options".style.visibility('hidden');
