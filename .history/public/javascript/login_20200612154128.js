...
function passwordValidate(event) {
    ...
    //     errortext[1].style.visibility = ("visible");
    //     redError[1].style.visibility = ("visible");
    //     errortext[1].innerText = "Password must contain a special character";
    //     event.preventDefault();
...
function setPasswordError(event) {
    icon[1].style.visibility = ("visible");
    errortext[1].style.visibility = ("visible");
...
//             document.querySelector(".warning").innerHTML = req.responseText;
//             console.log(req);

//     };
// }

//     req.open("POST", "/?Username="+ Username, true);
//     req.send();
// }
...
//     var messages = document.querySelector('.warning');  
//     const request = new XMLHttpRequest();
    
//     request.onload = () => {
//         console.log(request.responseText);
//         let responseObject = request.responsetext;
    
//         try{
//             responseObject = JSON.parse(request.responseText);
//         } catch (e) {
//             console.error('Could not pasrse JSON');
//         }
...
//     const requestData = `Username=${Joinbox.Username.value}`;
//     console.log(request);
