...
newName.textContent = comments.value; newDate.textContent = message.value; newMessage.textContent = message.value;

output.appendChild(newName); output.appendChild(newDate); output.appendChild(newMessage);
