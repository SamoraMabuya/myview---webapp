...
var iconTag = document.getElementsByTagName("i")[0];
        ...
        .then(function(data) {
            ...
            io.on("new_message", function(data) {
                ...
                data.forEach(function(user) {
                    ...
                    var newIcon = document.createAttribute("class")
                    ...
                    // newIcon.className = "picon";
                    newIcon.value = "fas fa-ellipsis-h picon";
                    ...
                    iconTag.setAttributeNode(newIconl)
