            ...
            io.on("new_message", function(data) {
                ...
                data.forEach(function(user) {
                 ...
                 <div class="output" data-id=${user.id}>
                    ...
                    <a href="#"><i class="fas fa-ellipsis-v icon" id="icon" ></i></a>
...
function hideShow(e) {
    ...
    const optionsChildren = optionsList.children;
    var id = 1;

    for (var i = 0; i < optionsChildren.length; i++) {
        var mose = optionsChildren + id++;
        optionsChildren.classList.add('is-hidden');
        console.log(optionsChildren + id++);
    }
}

//     let IconPressed = e.target.id == 'icon';
//     let optionsHide = e.target.id == 'options';
