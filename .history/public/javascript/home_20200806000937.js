        ...
        .then(function(data) {
            ...
            io.on("new_message", function(data) {
                ...
                data.forEach(function(user) {
                    ...
                    NewIconOptions.className = 'button';
                    newEdit.className = 'options edit';
                    newDelete.className = 'options delete';
                    ...
                    newMessage.appendChild(newEdit);
                    newMessage.appendChild(newDelete);
