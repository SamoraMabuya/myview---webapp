        ...
        .then(function(data) {
                ...
                io.on("new_message", function(data) {
                        ...
                        data.forEach(function(user) {
                                ...
                                newIcon.setAttribute("class", "fas fa-ellipsis-v icon"; newMessage.className = 'comments';
                                    ...
                                    newName.appendChild(display_username); newDate.appendChild(display_date); newMessage.appendChild(display_comments);

                                    newUser.appendChild(newName); newUser.appendChild(newDate); newUser.appendChild(newMessage); newDate.appendChild(newIcon); output.appendChild(newUser);
