...
function deleteOutput(message) {

    const messageDelete = document.querySelector(`[data-id="${message.id}"]`);
    const buttonDelete = document.querySelector(`.delete${message.id}`);
    ...
    output.addEventListener('click', function(e) {
        ...
        if (deleteButton) {
            ...
            fetch(`http://localhost:5502//${message.id}`, {
                    method: 'DELETE',
