        ...
        .then(function(data) {
            data.forEach(function(user) {
                ...
                io.on("new_message", function(data) {
                    var dater = JSON.parse(data)
                    for (var a = 0; a < datar.length; a++) {}
                    ...
                    var display_comments = document.createTextNode(data[a].message);
...
//                     var display_username = document.createTextNode(user.username);
//                     var display_date = document.createTextNode(user.date);
//                     var display_comments = document.createTextNode(data.message);
