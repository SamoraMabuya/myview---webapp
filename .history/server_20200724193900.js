...
server.post("/superhero-movies", function(req, res) {
    ...
    sqlDatabase.query("INSERT INTO comments (user_id, comments) VALUES (?)", [user, message], function(error, results, fields) {
...
server.get("/get_messages", function(request, result) {
