...
router.get("/superhero-movies", authenticationMiddleware(), function(req, res) {
    ...
    sqlDatabase.query("SELECT users.username, comments.comments, comments.date FROM users INNER JOIN comments ON users WHERE users.id=comments.id AND users.id",
