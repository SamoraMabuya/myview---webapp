...
router.get("/get_messages", function(request, result) {
    sqlDatabase.query("SELECT users.username, comments.id, comments.comments, comments.date FROM users INNER JOIN comments ON users.user_id=comments.user_id = users.username",
