...
router.get("/superhero-movies", function(req, res, err) {
    ...
    sqlDatabase.query("SELECT users.username, comments.comments, comments.date FROM users INNER JOIN comments ON users.user_id=comments.user_id",
        function(error, results, fields) {
            ...
            JSON.stringify({ username: results.username, date: results.date, comments: results.comments });
            console.log(JSON.stringify({ username: results.username, date: results.date, comments: results.comments }));
