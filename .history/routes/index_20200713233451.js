...
router.post("/superhero-movies", function(req, res) {
    ...
    // sqlDatabase.query('INSERT IGNORE INTO comments(comments) VALUES (?)', [comments],
    sqlDatabase.query('INSERT INTO comments (comments) VALUES (?)', [comments],
        ('SELECT id from users WHERE id = "241" ',
