...
router.get("/get_messages", function(request, result) {
    sqlDatabase.query("SELECT comments.id, users.username, users.id, comments.comments, comments.date FROM users INNER JOIN comments ON users.user_id=comments.user_id ",
