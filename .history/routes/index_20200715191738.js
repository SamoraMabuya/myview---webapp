...
router.post("/superhero-movies", function(req, res) {
            ...
            sqlDatabase.query('INSERT INTO comments (user_id, comments) VALUES (?, ?)', [user, comments], function(error, results, fields) {
                ...
                sqlDatabase.query("SELECT users.username, comments.comments, comments.date FROM users INNER JOIN comments ON users.user_id=comments.user_id WHERE users.email = 'time@force.com' ",
            ...
            // console.log(user.username, id.usernmae)
