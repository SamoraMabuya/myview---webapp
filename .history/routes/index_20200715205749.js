...
router.post("/superhero-movies", function(req, res) {
    ...
    sqlDatabase.query("SELECT users.username, comments.comments, comments.date FROM users INNER JOIN comments ON users.user_id=comments.user_id", [user],
...
router.get("/superhero-movies", authenticationMiddleware(), function(req, res) {
    ...
    sqlDatabase.query("SELECT users.username, comments.comments, comments.date FROM users INNER JOIN comments ON users.user_id=comments.user_id WHERE id = id", [user],
        function(error, results, fields) {
            if (error) throw error;


            console.log(user.username, user.date, user.comments);
            console.log(req.user.username, req.user.date, req.user.comments);
