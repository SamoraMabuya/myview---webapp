...
router.post("/superhero-movies", function (req, res) {
    ...
    sqlDatabase.query('SELECT * FROM users WHERE id = USER()', [comments], function (err, results, fields, res) {
        if (err) throw err;
        console.log(results);
        // return res.render('/superhero-movies');
        sqlDatabase.query('INSERT INTO users (comments) VALUES (171)', [comments], function (error, results, fields) {
