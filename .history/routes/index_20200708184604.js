...
router.post("/superhero-movies", function (req, res) {
    sqlDatabase.query('SELECT * FROM messages ', function (error, results, fields) {
    ...
    // sqlDatabase.query("INSERT INTO users(comments) VALUES ('" + data + "')", function (error, results) {
...
router.get("/superhero-movies", authenticationMiddleware(), function (req, res) {
    ...
    sqlDatabase.query("SELECT * FROM messages", function () {
