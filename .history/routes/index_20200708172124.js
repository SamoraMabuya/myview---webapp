...
router.post("/superhero-movies", function (req, res) {
    ...
    sqlDatabase.query('SELECT * FROM users WHERE comments = "SESSION_USER" ', function(error, res, results, fields) {
...
// });
    ...
    sqlDatabase.query('SELECT * FROM users WHERE ID = "SESSION_USER" ', async function(error, results, fields) {
        if (error) throw error;
...
router.get("/superhero-movies", authenticationMiddleware(), function (req, res) {
    ...
    // sqlDatabase.query('SELECT * FROM users', function (error, messages) {
    //     res.end(JSON.stringify(messages));
    sqlDatabase.query('SELECT * FROM users WHERE id = "SESSION_USER" ', function(error, results, fields) {
        if (error) throw error;
