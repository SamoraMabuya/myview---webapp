...
router.post("/superhero-movies", function (req, res) {
    ...
    sqlDatabase.query('SELECT * FROM users WHERE id = CURRENT_USER()', [comments], function (err, results, fields, res) {
        //stuff stuff
         sqlDatabase.query('INSERT INTO users (comments) VALUES (?)', [comments], function (error, results, fields) {
            // stuff stuff
