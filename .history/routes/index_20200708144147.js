...
router.post("/superhero-movies", function (req, res) {
    ...
    sqlDatabase.query('SELECT * FROM users WHERE ID = "CURRENT_USER()', async function(error, results, fields) {
    ...
    // sqlDatabase.end();
    // sqlDatabase.query("INSERT INTO users (comments) VALUES '"+ data + comments + "')", function(error, result) {
