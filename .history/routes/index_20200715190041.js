...
router.get("/superhero-movies", authenticationMiddleware(), function(req, res, results) {
    ...
    const sqlDatabase = require('../db.js');
    const user = req.user;
    sqlDatabase.query("SELECT users.username, comments.comments, comments.date FROM users INNER JOIN comments ON users_id=comments_id", [user, comments],
    ...
    results.forEach((user) => {
        console.log(user.username, user.date, users.comments);
        ...
        //             console.log(req.user_id.comments)
        //             console.log(fields);
