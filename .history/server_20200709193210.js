...
sqlDatabase.query('SELECT users.username, comments.comments, users.email FROM users INNER JOIN comments ON users.id=comments.id',
    function(error, results, fields) {
        if (error) throw error;

        results.forEach((id) => {
            console.log(id.username, id.email, id.comments)
        })
