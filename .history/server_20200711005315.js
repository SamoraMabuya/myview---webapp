...
sqlDatabase.query('SELECT users.username, comments.comments, comments.date sessions.sessionid FROM users, comments WHERE users.id=comments.id AND users.id = "148"',
