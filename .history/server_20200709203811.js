...
sqlDatabase.query('SELECT sessions.session_id users.username, comments.comments, comments.date,  FROM users, comments WHERE users.id=comments.id AND sessions.session_id = session_id'),
