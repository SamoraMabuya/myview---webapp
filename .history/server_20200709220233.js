...
// sqlDatabase.query('SELECT users.username, comments.comments, comments.date FROM users, comments WHERE users.id=comments.id AND users.id = "148"',
sqlDatabase.query("SELECT session_id FROM sessions WHERE id= {$_SESSION['id']} LIMIT 1",
