...
sqlDatabase.query('SELECT users.username, comments.comments, comments.date,  FROM users, comments WHERE users.id=comments.id AND sessions.session_id = session_id'),
